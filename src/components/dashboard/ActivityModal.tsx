...
import { X, CaretDown, Sparkle, Clock, Users, CalendarBlank } from '@phosphor-icons/react';
...
export function ActivityModal({ isOpen, onClose, kids }: ActivityModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Create as assignment item (the more flexible type)
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Create Activity">
      <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
        ...
        >
          <CaretDown className={cn("transition-transform", showAdvanced && "rotate-180")} />
          Advanced Options
        </button>
          ...
          <div className="space-y-4 pl-4 border-l-2 border-gray-200 dark:border-gray-700">
            ...
            {form.includeSteps && (
              <div className="space-y-2">
                ...
                <button type="button" onClick={addStep} className="text-sm text-[var(--ember-500)]">
                  + Add Step
                </button>
              </div>
            )}
            ...
            {form.includeRubric && (
              <div className="space-y-2">
                ...
                <button type="button" onClick={addRubricItem} className="text-sm text-[var(--ember-500)]">
                  + Add Criteria
                </button>
              </div>
            )}
