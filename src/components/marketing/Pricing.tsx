        ...
        <div className="relative">
          ...
          <div className="relative bg-[var(--night-700)] rounded-3xl border border-[var(--night-600)] p-10 md:p-12">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
              {/* Left: Price */}
              <div>
                <div className="inline-block px-4 py-1 rounded-full bg-gradient-ember text-white text-sm font-medium mb-4">
                  Early Access
                </div>
              ...
              <Link
                href="/signup"
                className="group px-8 py-4 bg-gradient-ember text-white rounded-2xl font-semibold text-lg hover:opacity-90 transition-all flex items-center justify-center gap-2 whitespace-nowrap shadow-lg"
              >
                Get Started
