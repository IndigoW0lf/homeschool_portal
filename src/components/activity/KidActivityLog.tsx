...
/**
 * Per-kid activity log section (for use inside kid progress containers)
 */
export function KidActivityLog({ kidId, kidName, initialEntries }: KidActivityLogProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* List - show most recent 5 for compact view */}
      <ActivityLogList 
