    ...
    <div className="space-y-8">
      ...
      <div className="p-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-xl border border-amber-200 dark:border-amber-800">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="text-center p-4 bg-white/50 dark:bg-gray-800/50 rounded-lg">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">Top Theme</div>
          </div>
        </div>

        {/* AI Message */}
        <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-amber-100 dark:border-amber-800">
      ...
      {highlightEntry && (
        <div className="p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-semibold text-gray-800 dark:text-gray-200">Memory Highlight</h3>
      ...
      {topTags.length > 0 && (
        <div className="p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold text-gray-700 dark:text-gray-300">Themes from {periodLabel}</h3>
          </div>
      ...
      <div>
        <button
          ...
          className="w-full py-3 text-center text-purple-600 dark:text-purple-400 hover:underline"
        >
          ...
          <div className="space-y-4 mt-4">
            {entries.map(entry => (
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-300">{entry.response}</p>
              </div>
            ))}
          </div>
        )}
